 ...
 * These effects use the definition below to determine the characteristics the
 * token is created with. The effect that creates a predefined token may also
 * modify or add to the predefined characteristics.
 * <p>

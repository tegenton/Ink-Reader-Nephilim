...
public enum PlayerVerb implements Word {
    ...
    CREATE, DECLARE, DESTROY, DISCARD, DIVIDE, DRAW, EXCHANGE, FLIP, IGNORE, LOOK, LOSE, MAY,
    OWN, PAY, PLAY, PREVENT, PUT, REGENERATE, REMOVE, REPLACE, RETURN, SACRIFICE, SEARCH,
